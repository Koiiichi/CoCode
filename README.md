...
- **Comments Panel**: Toggle with 💬 button to manage all comments
...
├── tree/
│   └── children/{path}/
├── versions/{encodedFileName}/
│   ├── version: number
│   ├── lastModified: timestamp
│   └── baseContent: string
├── comments/{encodedFileName}/{commentId}/
├── presence/{userId}/
└── cursors/{userId}/{encodedFileName}/
```
...
### Project Structure
```
my-collab-code-editor/
├── src/
│   ├── editor/           # Core editor modules
│   │   ├── presence.js   # User presence & cursors
│   │   ├── comments.js   # Inline commenting
│   │   ├── fileTree.js   # File organization
│   │   ├── conflictHandler.js # Merge conflicts
│   │   ├── runner.js     # Code execution
│   │   ├── devLogs.js    # Development logs
│   │   └── telemetry.js  # Analytics & metrics
│   ├── firebase/
│   │   └── paths.js      # Firebase path helpers
│   ├── editor.js         # Main editor logic
│   ├── login.js          # Authentication
│   ├── signup.js         # User registration
│   ├── home.js           # Project management
